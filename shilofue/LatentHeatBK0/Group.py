...
from shilofue.LatentHeatBK0.Cases import CASE, CASE_OPT
import numpy as np
...
\n\
  - default usage, create group: \n\
        Lib_LatentHeatBK0_Group create_group -j ~/ASPECT_PROJECT/aspectLib/tests/integration/fixtures/TwoDSubduction/test_group/test.json\n\
\n\
