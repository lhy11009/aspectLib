...
\n\
    python -m shilofue.ThDSubduction0.PlotParaview paraview_options -i /home/lochy/ASPECT_PROJECT/ThDSubduction/s07_cases_1/s07_bl4000.0_bw4000.0_sw1000.0 -sr slab.py\n\
\n\
        ")
...
def main():
    ...
    if (_commend in ['-h', '--help']):
        ...
        paraview_script = os.path.join(ASPECT_LAB_DIR, 'paraview_scripts',"ThDSubduction", arg.script)
