...
##### local rsync commands #####
# sync case restart files between two local folders
alias rsync_restart_local="rsync -avu --progress --exclude=*restart*.old --exclude=*solution* ${SCRATCH}/ThDSubduction/* ${ThDSubduction_DIR}/"
