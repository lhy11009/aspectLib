...
def test_visc_diff():
    ...
    '''
    source_case_dir = os.path.join(source_dir, "test_visc_diff")
...
def test_refine_wedge():
    '''
    test the particle method
    '''
    source_case_dir = os.path.join(source_dir, "test_refine_wedge")
    json_path = os.path.join(source_case_dir, 'case0.json')
    output_dir = os.path.join(test_dir,'test_refine_wedge')
    if os.path.isdir(output_dir):
        rmtree(output_dir)
    create_case_with_json(json_path, CASE, CASE_OPT)  # create case
    assert(os.path.isdir(output_dir))  # check case generation
...
def test_particle_method():
    '''
    test the particle method
    '''
    source_case_dir = os.path.join(source_dir, "test_particle_method")
    json_path = os.path.join(source_case_dir, 'case0.json')
    output_dir = os.path.join(test_dir,'test_particle_method')
    if os.path.isdir(output_dir):
        rmtree(output_dir)
    create_case_with_json(json_path, CASE, CASE_OPT)  # create case
    assert(os.path.isdir(output_dir))  # check case generation
...
def test_slab_strength():
    ...
    '''
    source_case_dir = os.path.join(source_dir, "test_slab_strength")
    json_path = os.path.join(source_case_dir, 'case0.json')
    output_dir = os.path.join(test_dir,'test_slab_strength')
    if os.path.isdir(output_dir):
        rmtree(output_dir)
    create_case_with_json(json_path, CASE, CASE_OPT)  # create case
    assert(os.path.isdir(output_dir))  # check case generation
